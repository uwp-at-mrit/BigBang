...
namespace WarGrey::SCADA {
	...
	public:
		...
		std::string select_from(const char* tablename, const char* order_by, uint64 limit = 0U, uint64 offset = 0U) override;
		std::string select_from(const char* tablename, const char* order_by, const char* cols[], size_t count, uint64 limit = 0U, uint64 offset = 0U) override;
