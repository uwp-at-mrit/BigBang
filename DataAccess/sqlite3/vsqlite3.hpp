...
namespace WarGrey::SCADA {
	...
	public:
		...
		std::string select_from(const char* tablename, const char* order_by, unsigned int limit = 0, unsigned int offset = 0) override;
		std::string select_from(const char* tablename, const char* order_by, const char* cols[], size_t count, unsigned int limit = 0, unsigned int offset = 0) override;
