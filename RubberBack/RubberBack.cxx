...
namespace WarGrey::SCADA {
    ...
    private ref class RubberBack sealed : public Application {
    protected:
        void Win2DAppMain(ApplicationView^ self, WorkSpace^ workspace) {
            CoreApplication::UnhandledErrorDetected += ref new UncaughtExceptionHandler(this, &RubberBack::OnUncaughtException);
            this->Suspending += ref new SuspendingEventHandler(this, &RubberBack::OnSuspending);
            self->VisibleBoundsChanged += ref new TypedEventHandler<ApplicationView^, Object^>(this, &RubberBack::DoResize);
...
int main(Platform::Array<Platform::String^>^ args) {
    auto lazy_main = [](ApplicationInitializationCallbackParams^ p) { ref new WarGrey::SCADA::RubberBack(); };
