...
namespace WarGrey::SCADA {
	private enum class GantryStatus {
		WindedUp, WindedOut, _
	};
	...
	public:
		Gantrylet(float radius, double degrees = 30.0);
		Gantrylet(WarGrey::SCADA::GantryStatus default_status, float radius, double degrees = 30.0);
