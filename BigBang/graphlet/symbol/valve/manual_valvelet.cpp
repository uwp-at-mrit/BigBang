...
ManualValveStyle WarGrey::SCADA::make_manual_valve_style(ICanvasBrush^ color) {
	ManualValveStyle s;
...
/*************************************************************************************************/
Valvelet::Valvelet(float radius, double degrees) : Valvelet(ManualValveStatus::Disabled, radius, degrees) {}

Valvelet::Valvelet(ManualValveStatus default_status, float radius, double degrees)
...
void Valvelet::prepare_style(ManualValveStatus status, ManualValveStyle& s) {
	switch (status) {
...
void Valvelet::on_status_changed(ManualValveStatus status) {
	switch (status) {
	case ManualValveStatus::Unopenable: {
