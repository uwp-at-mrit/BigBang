...
(define MODBUS_EXCEPTION_SLAVE_OR_SERVER_BUSY    #x05)
(define MODBUS_EXCEPTION_NEGATIVE_ACKNOWLEDGE    #x06)
(define MODBUS_EXCEPTION_MEMORY_PARITY           #x07)
(define MODBUS_EXCEPTION_NOT_DEFINED             #x08)
