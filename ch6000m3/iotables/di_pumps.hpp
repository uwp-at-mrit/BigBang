...
namespace WarGrey::SCADA {
	...
	static unsigned int console_ps_hydraulic_stop_button = 588U;
	static unsigned int console_sb_hydraulic_stop_button = 652U;
	static unsigned int sailing_hydraulic_stop_button = 622U;
