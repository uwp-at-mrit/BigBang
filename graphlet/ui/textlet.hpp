...
namespace WarGrey::SCADA {
	...
	WarGrey::SCADA::DimensionStyle make_setting_dimension_style(float nfontsize, unsigned int min_n, int precision = -1,
		Microsoft::Graphics::Canvas::Brushes::ICanvasBrush^ color = WarGrey::SCADA::Colours::Silver);

	WarGrey::SCADA::DimensionStyle make_highlight_dimension_style(float nfontsize, unsigned int min_n, int precision = -1,
	...
	WarGrey::SCADA::DimensionStyle make_highlight_dimension_style(float nfontsize, unsigned int min_label, unsigned int min_n, int precision,
		Microsoft::Graphics::Canvas::Brushes::ICanvasBrush^ label_color = WarGrey::SCADA::Colours::GhostWhite,
		Microsoft::Graphics::Canvas::Brushes::ICanvasBrush^ label_bgcolor = WarGrey::SCADA::Colours::ForestGreen);
	...
	protected:
		...
		double guarded_value(double v) override;
