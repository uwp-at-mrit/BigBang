...
namespace WarGrey::DTPM {
	...
	Platform::String^ enc_speak(WarGrey::DTPM::ENCErrorCode ecode, Platform::String^ cell_name = nullptr);
	Platform::String^ enc_speak(WarGrey::DTPM::ENCErrorCode ecode, const char* cell_name);

	private ref class ENChartDocument abstract {
	public:
		static WarGrey::DTPM::ENChartDocument^ load(Platform::String^ filename, WarGrey::DTPM::ENChartDoctype type);
